			...
			<div className="item col s12 m6">
				<div className="box">
					...
					<div className="content">
						<h3 className="text-primary"><Link to={this.props.data.node.fields.slug} title={this.props.data.node.frontmatter.title}>{this.props.data.node.frontmatter.title}</Link></h3>
